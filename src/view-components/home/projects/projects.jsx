...
const projectsList = [
  ...
  theTwentiethImage,
  theThirteenthImage,
  theTwentieFirstImage,
  theTwentieSecondImage,
  theTwentieThirdImage,
  theTwentieForthImage,
  theTwentieFifthImage,
  theTwentieSixthImage,
  theTwentieSeventhImage,
  theTwentieEighthImage,
  theTwentieNinthImage,
  theThirteenImage,
];
